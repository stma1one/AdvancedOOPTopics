...
namespace Delegates
{
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            IsTrue = Demo.IsExists;
           
            bool answer = IsTrue(arr, 9);
            print(answer);
            IsTrue += Demo.IsAllBigger;
            answer = IsTrue(arr, 9);
            print(answer);
            #endregion
            ...
            Action<object> PrintAnswer= Demo.WriteMessage; 
            ...
            PrintAnswer(Demo.Check(arr, 9, Demo.IsAllBigger));
            PrintAnswer(Demo.Check(arr, 9, Demo.IsExists));
            #endregion
